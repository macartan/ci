...
before teh first class please make sure your `R` is up-to-date and that you are working in `R studio`. Then make sure you have the following packages installed.
