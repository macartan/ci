...
Recall this joint distribution with binary X and binary Y from [here](https://macartan.github.io/ci/ci_2025.html#/example-without-identification-2)
...
if(run)
  stan(file = "assets/one_var.stan", 
          data = some_data) |>
  write_rds(here::here("slides", "saved/one_var.rds"))

M <-   read_rds(here::here("slides", "saved/one_var.rds"))
...
if(run)
  ...
  write_rds(here::here("slides", "saved/one_var_2.rds"))

M2 <-   read_rds(here::here("slides", "saved/one_var_2.rds"))
```
...
if(run) 
  ...
  write_rds(here::here("slides", "saved/ml_model.rds"))

M_ml  <-  read_rds(here::here("slides", "saved/ml_model.rds"))
...
if(run)
  stan(model_code = game_model,  
           data = list(play = c(10,10,10))) |>
  write_rds(here::here("slides", "saved/M3.rds"))

M3 <- read_rds(here::here("slides", "saved/M3.rds"))
...
if(run)
  stan(model_code = game_model,  
           data = list(play = c(20,6,4))) |>
  write_rds(here::here("slides", "saved/M4.rds"))

M4 <- read_rds(here::here("slides", "saved/M4.rds"))
```
...
lipids_model <- read_rds(here::here("slides", "saved/lipids_model.rds"))

results <- read_rds(here::here("slides", "saved/lipids_results.rds"))
