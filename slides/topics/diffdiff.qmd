...
if(run)
  ...
  write_rds(here::here("slides", "saved/dd1.rds")) 

read_rds(here::here("slides", "saved/dd1.rds")) |>
...
if(run)
  ...
  redesign(n_units = 10) |>  
  diagnose_design(bootstrap_sims = 0)  |>
  write_rds(here::here("slides", "saved/dd10.rds"))

read_rds(here::here("slides", "saved/dd10.rds")) |>
  reshape_diagnosis() |> select(Inquiry, Estimator, Bias) |> kable()

```

### Extends to multiple units easily
...
```{r, echo = FALSE}
include_graphics(here::here("slides", "assets", "Goodman-Bacon.png"))
```
...
```{r}
knitr::include_graphics(here::here("slides", "assets", "didtools.jpg")))
```
