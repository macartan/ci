...
knitr::include_graphics(here::here("slides", "figs/collider.png"))
```
...
model |> update_model(data = truth |> make_data(n = 1000), iter = 5000) |>
  write_rds(here::here("slides", "saved/cq-mediation.rds"))

read_rds(here::here("slides", "saved/cq-mediation.rds")) |> 
    query_distribution(queries = queries, using = "posteriors") |>
  gather(var, val) |> 
...
```{r, include = FALSE}
read_rds(here::here("slides", "saved/cq-mediation.rds"))$posterior_distribution |> apply(2, mean)
```
