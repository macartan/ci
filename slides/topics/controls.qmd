...
```{r, echo = FALSE}
if(run)
  design |> diagnose_design(bootstrap_sims = 0) |>write_rds(here::here("slides", "saved/demeaned.rds"))

read_rds(here::here("slides", "saved/demeaned.rds")) |> reshape_diagnosis() |> 
...
if(run)
  ...
  redesign(
    ...
    prob = seq(0.1, 0.9, 0.1)) |> 
  diagnose_designs() |>
  write_rds(here::here("slides", "saved/freedman18.3.rds")) 

read_rds(here::here("slides", "saved/freedman18.3.rds"))$diagnosands_df |> 
...
if(run)
  ...
  write_rds(here::here("slides", "saved/tocontrolornot.rds"))

simulations <-  read_rds(here::here("slides", "saved/tocontrolornot.rds")) |>
