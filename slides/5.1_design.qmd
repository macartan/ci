...
knitr::include_graphics(here::here("slides", "figs/labfield.jpg"))
```
...
```{r dictionary, echo = FALSE, fig.align='center', fig.cap="A survey dictionary with results from a complex randomization presented in a simple way for enumerators"}
knitr::include_graphics(here::here("slides", "figs/dictionary.png"))
```
...
```{r, echo = FALSE, fig.align='center'}
include_graphics(here::here("slides","figs/bf.png"))
```
...
if(run)
  ...
  write_rds(here::here("slides", "saved/assignment_diagnosis.rds"))

diagnoses <- read_rds(here::here("slides", "saved/assignment_diagnosis.rds")) 
...
### Indirect assignments: Adjacency matrix {.smaller}
...
if(run) 
  ...
  apply(1, mean) |>
  write_rds(here::here("slides", "saved/wild_1.rds"))

indirect_propensities_1 <-  read_rds(here::here("slides", "saved/wild_1.rds"))
...
if(run) 
  replicate(5000, draw_data(design |> redesign(n_assigned = 25))$indirect) |> 
  apply(1, mean) |>
  write_rds(here::here("slides", "saved/wild_2.rds"))

indirect_propensities_2 <-  read_rds(here::here("slides", "saved/wild_2.rds"))
