...
* Equivalent: priobability of getting an estimate above 1.96 or below -1.96.
...
where $((n - 1)\rho + 1)$ is the "design effect": $\frac{nK}{((n - 1)\rho + 1)}$ is the "effective sample size"
