...
data <- data.frame(
  treatment = c("Masked information on respondents", "Full information on respondents"),
...
kable(data, format = "html", booktabs = TRUE, caption = "Return rates given investments under different conditions") %>%
...
kable(data, format = "html", booktabs = TRUE, caption = "Potential outcomes with (and without) identity protection") %>%
  kable_styling(latex_options = c("striped", "hold_position"), font_size = 25, latex_table_env = "scriptsize", full_width = FALSE) %>%
...
kable(data, format = "html", booktabs = TRUE, caption = "Outcomes when respondent is visible") %>%
  kable_styling(latex_options = c("striped", "hold_position"), font_size = 25, latex_table_env = "scriptsize", full_width = FALSE) %>%
  add_header_above(c(" ", "Responder’s return decision (given type)" = 6, "Avg.")) 
...
kable(data, format = "html", booktabs = TRUE, caption = "Outcomes when respondent is not visible") %>%
  kable_styling(latex_options = c("striped", "hold_position"), font_size = 25, latex_table_env = "scriptsize", full_width = FALSE) %>%
  add_header_above(c(" ", "Responder’s return decision (given type)" = 6, "Avg."))  
...
### Conditional distributions 1 {.smaller}
...
### Conditional distributions 2{.smaller}
...
### Conditional distributions 4 {.smaller}
...
### Conditional distributions 5  {.smaller}
...
### Conditional distributions 7 {.smaller}
...
### Conditional independence  ## Causal graphs basics 1 {.smaller}
...
### Recap: Ten things you need to know about causal inference {.smaller}
