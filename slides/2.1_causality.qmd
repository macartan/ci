...
# Custom labels
custom_labels <- c("Treatment", "% invested (average)", "...when 10% invested", "...when 50% invested")
...
### Conditional distributions 3{.smaller}
...
If $P(a,b,c)$ is Markov relative to this this graph then: $C$ should be independent of $A$ given $B$
...
$\Pr(\theta^Y =\theta^Y_{01}) = \lambda^Y_{01}$
