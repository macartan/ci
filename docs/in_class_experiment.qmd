...
8. Now turn over all the cards:
    1. calculate the true difference between the numbers 
    4. using the calculations you have, estimate: 
          1. whether you design was biased            
    ...
    3. calculate the correlation between the black numbers and the prompt (if any)
