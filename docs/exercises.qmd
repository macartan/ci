---
title: "puzzles for causal infernece and experimental design"
...
2. Set a rule and rerandomize if the rule is broke, then procede as normal
3. Randomize many times and select the set of randomizations that meet your rule. Then select from that set at random. 

In case 3 you can make use of your knowledge of the randomization to generate asssignment propensities and implement randomization inference.
