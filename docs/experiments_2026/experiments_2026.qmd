...
|----------------|-----------------------:|
| **Macartan Humphreys** | Lennard Naumann |
| [macartan.humphreys@wzb.eu](mailto:macartan.humphreys@wzb.eu) | [lennard.naumann@wzb.eu](mailto:lennard.naumann@wzb.eu) |
| [macartan.github.io](https://macartan.github.io/) | E306 |


**Overview**: The course addresses the design and analysis of experiments. It is a hands-on course in which theoretical results are introduced through lecture, demonstrated in practice, and worked on in groups. In-class discussions focus on major works, features of designs, and experimental strtegies. Topics include randomization schemes, analysis strategies, design evaluation, and workflows. 
...
-   This syllabus: <https://macartan.github.io/ci/syllabus_experiments_2026.pdf>

-   Slides: <https://macartan.github.io/ci/slides_experiments_2026.html>
...
**Instructor office hours**: Fridays, 13:00 - 15:00, in person

**Teaching assistant office hours**: Wednesdays, 13:00 - 14:00 on [Zoom](https://hu-berlin.zoom-x.de/j/68850907617) (excluding 25 Feb)
...
-   Develop group field experiment 1, decide on strategy, and start ethics application
...
- [APSA guidelines](https://connect.apsanet.org/hsr/principles-and-guidance/)
...
Optional pieces on experimentation:
...
Optional substantive pieces:

-   @kurzban2001can
-   [@haasPersuasionProtestsDirect2025](https://osf.io/42s8e/download)
-   @mousa2020building
-   @dietrichSeeingRacialAvoidance2023a

## Causality (30 January)
...
**To do before class**: 1. the readings; 2. collectively complete a pre-analysis plan and [ethics application](https://wiki.wzb.eu/de/nsfr_img_auth.php/8/8d/Ethics_Full_Review_Form_new.docx) for Experiment 1
...
## Experimental Design and Evaluation (20 February)
...
- @roth1986laboratory [@palfrey2009laboratory]


### Experiments on networks

- @baird2014designing [Optional:    @sinclair2012detecting;   [@aronow2017estimating](https://arxiv.org/abs/1305.6156)]
